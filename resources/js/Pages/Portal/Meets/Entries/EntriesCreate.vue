        ...
        <div class="mx-auto">
            <div class="bg-white dark:bg-gray-600 shadow rounded-md">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div
                        class="px-8 py-4 bg-gray-50 dark:bg-dark-eval-3 border-t border-gray-100 dark:border-gray-900 flex items-center justify-between mt-5">
                        <jet-button :loading="form.processing"
                                    :disabled="form.entries.length == 0 || form.competitor_id == null">
                            {{__('Save')}}
                        </jet-button>
                    </div>
                </form>
